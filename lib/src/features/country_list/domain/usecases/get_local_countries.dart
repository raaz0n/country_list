...
class GetSaveCountries extends UseCase<List<CountryEntity>, NoParams> {
  final CountryRepository countryRepository;
  GetSaveCountries(this.countryRepository);

  @override
  Future<Either<AppError, List<CountryEntity>>> call(NoParams noParams) async {
    return await countryRepository.getSaveCountries();
  }
}
